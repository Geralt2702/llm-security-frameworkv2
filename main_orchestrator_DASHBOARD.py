"""
LLM Security Testing Framework - WITH LIVE DASHBOARD
Compatible with Ollama Python 0.6.0+
Real-time monitoring on http://localhost:5000
Version: 1.0 PRODUCTION + DASHBOARD
"""
import sys
import argparse
import json
...
class FrameworkOrchestrator:
    """Main orchestrator with live dashboard support"""
    ...
    def run_full_test(self, models, attack_count=20):
        """Run comprehensive security test with live dashboard"""
        print("\n" + "="*70)
        print("🔒 LLM SECURITY TESTING FRAMEWORK - WITH LIVE DASHBOARD")
        print("="*70 + "\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="LLM Security Framework - WITH LIVE DASHBOARD",
        epilog="Example: py -3.13 main_orchestrator_DASHBOARD.py --models gemma3 --attacks 20"
    )
